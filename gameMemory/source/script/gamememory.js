...
var envinfo = {"qx.application":"gamememory.Application","qx.revision":"","qx.theme":"gamememory.theme.Theme","qx.version":"5.0.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"gamememory":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../../qooxdoo/framework/source/resource","sourceUri":"../../qooxdoo/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
